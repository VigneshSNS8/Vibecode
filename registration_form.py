...
WEBHOOK_URL = "https://vignesh8492.app.n8n.cloud/webhook-test/registration"  # Updated to a cleaner URL
...
with st.form(key="registration_form"):
    ...
    event_date = st.selectbox("Event Date", ["Select a date", "2025-07-01", "2025-07-02", "2025-07-03"])
    submit_button = st.form_submit_button("Register")

    # Validation and submission logic
    if submit_button:
        # Check if all fields are filled
        if not name or not contact or occupation == "Select your occupation" or not email or expertise == "Select your expertise level" or event_date == "Select a date":
...
- **Event Date** selection is required to confirm your participation slot.
