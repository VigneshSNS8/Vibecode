...
with st.form(key="registration_form"):
    ...
    event_date = st.date_input(
        ...
        max_value=date(2025, 7, 3),
        value=date(2025, 7, 1),  # Default to first available date
        help="Click to open the calendar and select a date between July 1-3, 2025. Use the arrows to navigate months and years."
    )
